...
namespace HexagonPackage
{
    ...
    public struct Cube
    {
        ...
        private static readonly Cube zero = new Cube(0, 0);
        public static Cube Up
        {
            get
            {
                return up;
        ...
        private static readonly Cube up = new Cube(0, 1);
        public static Cube Down
        {
            get
            {
                return down;
        ...
        private static readonly Cube down = new Cube(0, -1);
        public static Cube Left
        {
            get
            {
                return left;
        ...
        private static readonly Cube left = new Cube(-1, 0);
        public static Cube Right
        {
            get
            {
                return right;
        ...
        private static readonly Cube right = new Cube(1, 0);
        ...
        public static Cube Round(float x, float y, float z)
        {
